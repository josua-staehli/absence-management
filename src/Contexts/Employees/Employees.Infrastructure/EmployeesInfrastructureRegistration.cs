...
{
    /// <summary>
    ///     Everything the employees bounded context needs to talk to the database. The concrete
    ...
    {
        services.AddBoundedContextDbContext<EmployeesDbContext>(connectionString);
        ...
        // The published contract. Registering it here allows another bounded context to depend on
        // the interface without knowing what implements it.
