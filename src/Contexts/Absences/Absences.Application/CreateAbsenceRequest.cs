    ...
    TimeProvider timeProvider) : ICommandHandler<CreateAbsenceRequestCommand, Guid>
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // A request needs an employee, and the employee lives in another bounded context: this is
        // a question asked across the boundary rather than a join or a foreign key. The answer
        // carries exactly what this bounded context needs to know - the employee exists - and
        // nothing else.
