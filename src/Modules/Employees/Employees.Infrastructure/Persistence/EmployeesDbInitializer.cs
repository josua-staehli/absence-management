...
/// <summary>
///     Applies the migrations of this module and seeds the employees. Registered as an
///     <see cref="IDbInitializer" />, so the host runs it together with every other module's
///     initializer.
/// </summary>
