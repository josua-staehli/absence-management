...
///     EF Core.
///     <para>
///         The employee appears as a plain id: employees are a module of their own, so this
///         aggregate can only carry the reference, never the employee itself. Whether that id
///         belongs to somebody is asked once, in the use case, across the module boundary.
///     </para>
/// </summary>
