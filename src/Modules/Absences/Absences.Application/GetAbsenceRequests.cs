...
/// <summary>
///     Two modules own two halves of this list, so it is one query per module and a lookup in
///     memory instead of a SQL join. That is the price of the boundary.
/// </summary>
    ...
    : IQueryHandler<GetAbsenceRequestsQuery, IReadOnlyList<AbsenceRequestDto>>
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // One call for the whole list, not one per row: crossing a module boundary inside a loop
        // is the easiest way to turn a list into an N+1.
