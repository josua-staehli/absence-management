...
/// <summary>
///     Stands in for the employees bounded context. That the whole of it can be replaced by this
///     class is the point of the contract: these tests cannot break because something changes
///     inside the employees bounded context, only because the two stop agreeing.
/// </summary>
