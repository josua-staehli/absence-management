...
/// <summary>
///     The outward-facing side of the Employees module.
/// </summary>
public class EmployeeDirectoryTests
{
    ...
    /// <summary>
    ///     An unknown id is an answer, not a failure. The absences module asks this question to
    ///     find out whether a request may be created at all.
    /// </summary>
    [Fact]
    ...
    ///     absences module has to survive. It is left out of the answer rather than reported, and
    ///     the caller substitutes its own placeholder - see
